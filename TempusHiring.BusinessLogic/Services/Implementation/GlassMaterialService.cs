...
{
    public class GlassMaterialService : CrudService<GlassMaterial, GlassMaterialDTO>, IGlassMaterialService
    {
        public GlassMaterialService(IRepository<GlassMaterial> repository, IUnitOfWork unitOfWork, IMapper mapper)
