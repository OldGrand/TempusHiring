...
{
    public class StrapService : CrudService<Strap, StrapDTO>, IStrapService
    {
        public StrapService(IRepository<Strap> repository, IUnitOfWork unitOfWork, IMapper mapper)
